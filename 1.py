...
<title>Neon OSINT</title>          <link rel="icon" type="image/x-icon" href="/static/icons/favicon.ico">          <script src="https://cdn.tailwindcss.com"></script>          <style>          
body {          
...
<body class="flex flex-col items-center justify-center min-h-screen px-4">          
  ...
  <h3 class="text-gray-400 mb-6 text-lg">Number to Information Tool</h3>            <div class="card w-full max-w-lg">          <form id="lookupForm" class="flex flex-col gap-4 mt-4">          
